                     ...
                     <div class="col-xs-12">
                         <div class="col-md-12">
            				...
            				<div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <button type="button" class="btn btn-primary" onclick="Cari()"><i class='fa fa-search'></i> Cari</button>
                              </div>
            				</div>
            				<input type="hidden" name="niplama" id="niplama">
            				<input type="hidden" name="namauser" id="namauser">
            				<input type="hidden" name="email" id="email">
            				<input type="hidden" name="seksi" id="seksi">
            				<div class="form-group">
            				...
            				<div class="form-group">
                              ...
                              <div class="col-sm-10" >
            				  <textarea class="form-control" rows="3" id="tujuan" name="tujuan" placeholder="Diskripsi dari aplikasi" required><?php if ($_SERVER['REQUEST_METHOD'] == 'POST') echo$_POST['tujuan'] ?></textarea>
            				  </div>
                            </div>
